...
const objLat = (obj) => {
    return `my name is ${obj.firstName.charAt(0).toUpperCase()}${obj.firstName.slice(1, obj.firstName.length)} ${obj.lastName.charAt(0).toUpperCase()}${obj.lastName.slice(1, obj.lastName.length)} I am ${obj.age} YO, and I love ${obj.hobby}.`;
};
// -------------------------------------------------------------------------------------------------------
...
const applicationsStatics = (arr) => {
    ...
    let rejected_Applicants= 0;

    for (let i = 0; i < arr.length; i++){  

        switch(arr[i].tech.toLocaleLowerCase()){
            case 'python': 
                pythondevs++;
                break;
        ...
        if((arr[i].firstName !== null && arr[i].lastName !== null) || (arr[i].firstName !== '' && arr[i].lastName !== '')){
            if(arr[i].yearsOfExperience <= 1){
                rejected_Applicants++;
            }
        }
        ...
        return{
            ...
            rejectedApplicants:rejected_Applicants
        };
    }
};
// -------------------------------------------------------------------------------------------------------
